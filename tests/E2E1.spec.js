...
test('@web First E2E Test standalone test', async ({ page }) => {
    ...
    //const deleteButtonsOnCartPage = "button.btn.btn-danger"
    //const deleteButtonsOnCartPage = wholeCart.locator("button.btn.btn-danger")
    ...
    const emailId1 = await page.inputValue('[id="userEmail"]');
    console.log('Email id is :', emailId1)
